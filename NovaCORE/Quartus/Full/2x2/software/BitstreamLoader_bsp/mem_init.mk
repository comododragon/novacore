...
# Memory: bitstream_memory
MEM_0 := bitstream
$(MEM_0)_NAME := bitstream_memory
...
$(MEM_0)_HIERARCHICAL_PATH := bitstream_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: bitstream_memory
bitstream_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym

# Memory: onchip_memory2
MEM_1 := NovaCOREBlaster_onchip_memory2
